...
TEST(BinaryNodeTest, StringNodeSpecialCases)
{
  ...
  EXPECT_NO_THROW(BinaryNode<std::string> specialNode("!@#$%^&*()")) << "Constructor with special characters should not throw";
  EXPECT_NO_THROW(BinaryNode<std::string> unicodeNode("Hello世界")) << "Constructor with Unicode characters should not throw";
